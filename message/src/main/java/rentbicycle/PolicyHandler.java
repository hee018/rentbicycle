...
public class PolicyHandler{
    ...
    @StreamListener(KafkaProcessor.INPUT)
    public void wheneverPaymentadded_AddPaymentMessage(@Payload Paymentadded paymentadded){

        if(!paymentadded.validate()) return;

        System.out.println("\n\n##### listener AddPaymentMessage : " + paymentadded.toJson() + "\n\n");
